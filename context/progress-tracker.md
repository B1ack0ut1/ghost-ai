...
- Feature 03 authentication is complete. Clerk now owns sign-in/sign-up UI, route protection, root redirects, and the editor user menu while preserving the app's dark token system.
...
- Build the project metadata layer and project list/create flow once the next feature unit is specified.
